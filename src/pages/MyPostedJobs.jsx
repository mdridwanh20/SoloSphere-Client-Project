...
const MyPostedJobs = () => {
  ...
  const modernDelete = (id) => {
    toast(
      ...
      { position: "top-center" } // Set toast position to center
    );
  };
                ...
                <tbody className='bg-white divide-y divide-gray-200 '>

                  {
                    jobs.map((job) => <tr
                      ...
                      <td className='px-4 py-4 text-sm text-gray-500  whitespace-nowrap'>
                        {job.deadline ? format(new Date(job.deadline), 'MMMM dd, yyyy') : 'N/A'}
                      </td>

                      <td className='px-4 py-4 text-sm text-gray-500  whitespace-nowrap'>
                        <b>Range:</b> ${job.minPrice || 'Not Available'} - ${job.maxPrice || 'Not Available'}
                      </td>
                        ...
                        <div className='flex items-center gap-x-2'>
                          ...
                          <p
                            className={`px-3 py-1 text-xs rounded-full 
                              ...
                              : job.category === 'Graphic Design' ? 'text-red-500 bg-red-100'
                      ...
                      <td className='px-4 py-4 text-sm text-gray-500  whitespace-nowrap'>
                        {job.description.substring(0, 15) || 'Not Available'}...
                      </td>
                      <td className='px-4 py-4 text-sm whitespace-nowrap'>
