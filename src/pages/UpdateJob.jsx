...
// update form
const handlerJobUpdate = async (e) => {
  e.preventDefault();
  ...
  return (
    <div className='flex justify-center items-center min-h-[calc(100vh-306px)] my-12'>
      <section className=' p-2 md:p-6 mx-auto bg-white rounded-md shadow-md '>
        ...
        <form onSubmit={handlerJobUpdate}>
          <div className='grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2'>
            ...
            <div>
              ...
              <input
                ...
                disabled
                className='block w-full px-4 py-2 mt-2 text-gray-400 bg-white border border-gray-200 rounded-md  focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring'
              />
            </div>
